                ...
                <div class="flex-shrink-0 flex h-16 bg-white shadow">
                    <div class="flex-1 px-4 flex justify-between items-center">
                        <div class="flex-1 flex">
                            <h1 class="text-xl md:text-2xl font-semibold text-gray-900 self-center">Mes Devis</h1>
                        </div>
                        <!-- Refresh button -->
                        <button 
                            @click="fetchDevis"
                    ...
                    <div class="py-4 md:py-6">
                        <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
                            ...
                            <div v-if="loading" class="flex justify-center items-center py-12">
                                ...
                                <span class="ml-3 text-gray-600">Chargement des devis...</span>
                            </div>
                            ...
                            <div v-else class="bg-white shadow rounded-lg overflow-hidden">
                                <div class="px-4 py-5 sm:px-6 border-b border-gray-200 flex flex-col sm:flex-row justify-between items-start sm:items-center">
                                    <div>
                                        ...
                                        <p class="mt-1 text-sm text-gray-500">{{ devis.length }} devis au total</p>
                                    </div>
                                    <div class="mt-4 sm:mt-0">
                                        <span class="text-sm text-gray-500">
                                            Total général: <span class="font-semibold text-gray-900">{{ formatPrice(calculateGrandTotal()) }} DH</span>
                                        </span>
                                    </div>
                                </div>
                                        ...
                                        <tbody class="bg-white divide-y divide-gray-200">
                                            <tr v-for="devi in devis" :key="devi.id" class="hover:bg-gray-50 transition-colors duration-150">
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <div class="text-sm font-medium text-gray-900">{{ devi.name || devi.product_name || 'Produit inconnu' }}</div>
                                ...
                                <div class="md:hidden">
                                    <div class="divide-y divide-gray-200">
                                        <div v-for="devi in devis" :key="devi.id" class="p-4 hover:bg-gray-50 transition-colors duration-150">
                                            ...
                                            <div class="mb-3">
                                                <p class="text-sm font-medium text-gray-900">{{ devi.name || devi.product_name || 'Produit inconnu' }}</p>
                                ...
                                <div class="bg-gray-50 px-4 py-4 sm:px-6">
                                    <div class="flex justify-between items-center">
                                        <span class="text-sm font-medium text-gray-900">Total Général</span>
