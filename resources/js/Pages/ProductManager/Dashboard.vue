            ...
            <div class="flex flex-col w-64 bg-green-800">
                ...
                <div class="h-0 flex-1 flex flex-col overflow-y-auto">
                    ...
                    <nav class="mt-5 px-2 space-y-1">
                        <a href="product-manager-dashboard.html" class="bg-green-700 text-white group flex items-center px-2 py-2 text-base font-medium rounded-md">
                        ...
                        <a href="/productManager/Product/Category" class="text-green-100 hover:bg-green-700 group flex items-center px-2 py-2 text-base font-medium rounded-md">
                            <svg class="mr-3 h-6 w-6 text-green-300" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <a href="product-manager-products.html" class="text-green-100 hover:bg-green-700 group flex items-center px-2 py-2 text-base font-medium rounded-md">
                            <svg class="mr-3 h-6 w-6 text-green-300" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <a href="#" class="text-green-100 hover:bg-green-700 group flex items-center px-2 py-2 text-base font-medium rounded-md">
                            <svg class="mr-3 h-6 w-6 text-green-300" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    <ul class="divide-y divide-gray-200">
                                            ...
                                            <div class="px-4 py-4 sm:px-6">
                                                <div class="flex items-center justify-between">
                                                    <p class="text-sm font-medium text-green-600 truncate">
                                                        Added new product: Electric Scooter X1
                                                    </p>
                                        ...
                                        <li>
                                            <div class="px-4 py-4 sm:px-6">
                                                <div class="flex items-center justify-between">
                                                    <p class="text-sm font-medium text-green-600 truncate">
                                                        Updated category: Electric Vehicles
                                                    </p>
                                                    <div class="ml-2 flex-shrink-0 flex">
                                        ...
                                        <li>
                                            <div class="px-4 py-4 sm:px-6">
                                                <div class="flex items-center justify-between">
                                                    <p class="text-sm font-medium text-green-600 truncate">
                                                        Added new product: Solar Power Bank 20000mAh
                                                    </p>
                                                    <div class="ml-2 flex-shrink-0 flex">
                                                        <p class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">
                                                            Product
                                        ...
                                        <li>
                                            <div class="px-4 py-4 sm:px-6">
                                                <div class="flex items-center justify-between">
                                                    <p class="text-sm font-medium text-green-600 truncate">
                                                        Created new category: Sustainable Home Products
                                                    </p>
                                                    <div class="ml-2 flex-shrink-0 flex">
                                                        <p class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-blue-100 text-blue-800">
                                                            Category
