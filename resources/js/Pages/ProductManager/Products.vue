                                        ...
                                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                                            ...
                                            <div v-for="product in filteredProducts" :key="product.id"
                                                ...
                                                <div class="aspect-w-3 aspect-h-2">
                                                    <img class="object-cover w-full h-48" :src="`/storage/${product.image}`" alt="Product image">
                                                </div>
                                                <div class="p-4">
                                                    ...
                                                    <div class="mt-4 flex flex-col sm:flex-row gap-2">
                                                        <button @click="editProduct(product)"
                                                            class="flex-1 inline-flex justify-center items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
                                                        ...
                                                        <button @click="confirmDelete(product)"
                                                            class="flex-1 inline-flex justify-center items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
                                                            <svg class="-ml-0.5 mr-2 h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                ...
                <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full">
                                ...
                                <div class="mt-4">
                                    <form @submit.prevent="submitProduct" id="product-form" class="space-y-6">
                                        ...
                                        <div>
                                            ...
                                            <div class="mt-1">
                                                <input v-model="productForm.name" type="text" id="product-name" name="product-name" required
                                        ...
                                        <div>
                                            ...
                                            <div class="mt-1">
                                                <textarea v-model="productForm.description" id="product-description" name="product-description" rows="3"
                                        ...
                                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                            <div>
                                                ...
                                                <div class="mt-1">
                                                    <input v-model="productForm.price" @input="countMarge" type="number" step="0.01" id="product-price" name="product-price" required
                                                        class="shadow-sm focus:ring-green-500 focus:border-green-500 block w-full sm:text-sm border-gray-300 rounded-md">
                                                    <div v-if="errors.price" class="text-red-500 text-sm mt-1">{{ errors.price[0] }}</div>
                                                </div>
                                            </div>
                                            <div>
                                                <label for="product-stock" class="block text-sm font-medium text-gray-700">Stock</label>
                                                <div class="mt-1">
                                                    <input v-model="productForm.stock" type="number" id="product-stock" name="product-stock" required
                                                        class="shadow-sm focus:ring-green-500 focus:border-green-500 block w-full sm:text-sm border-gray-300 rounded-md">
                                                    <div v-if="errors.stock" class="text-red-500 text-sm mt-1">{{ errors.stock[0] }}</div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                            <div>
                                                ...
                                                <div class="mt-1">
                                                    <input v-model="productForm.marge" @input="countMarge" type="number" id="product-marge" name="product-marge" required
                                                        class="shadow-sm focus:ring-green-500 focus:border-green-500 block w-full sm:text-sm border-gray-300 rounded-md">
                                                    <div v-if="errors.marge" class="text-red-500 text-sm mt-1">{{ errors.marge[0] }}</div>
                                                </div>
                                            </div>
                                            <div>
                                                <label for="product-SellPrice" class="block text-sm font-medium text-gray-700">Sell Price</label>
                                                <div class="mt-1">
                                                    <input v-model="productForm.Sprice" @input="countMarge" type="number" id="product-SellPrice" name="product-SellPrice" required
                                                        class="shadow-sm focus:ring-green-500 focus:border-green-500 block w-full sm:text-sm border-gray-300 rounded-md">
                                                    <div v-if="errors.Sprice" class="text-red-500 text-sm mt-1">{{ errors.Sprice[0] }}</div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <div class="mt-1">
                                                <select v-model="productForm.categorie_id" id="product-category" name="product-category" required
                                                    class="shadow-sm focus:ring-green-500 focus:border-green-500 block w-full sm:text-sm border-gray-300 rounded-md">
                                                ...
                                                <div v-if="errors.categorie_id" class="text-red-500 text-sm mt-1">{{ errors.categorie_id[0] }}</div>
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <div class="mt-1 flex flex-col sm:flex-row sm:items-center space-y-3 sm:space-y-0 sm:space-x-4">
                                                <div v-if="isEditing">
                                                    <div v-if="productForm.imagePreview" class="flex-shrink-0 h-16 w-16 bg-gray-100 rounded-md overflow-hidden">
                                                        <img :src="`/storage/${productForm.imagePreview}`" alt="Product preview" class="h-full w-full object-cover">
                                                    </div>
                                                    <div v-else class="flex-shrink-0 h-16 w-16 bg-gray-100 rounded-md flex items-center justify-center">
                                                ...
                                                <div v-else>
                                                    <div v-if="productForm.imagePreview" class="flex-shrink-0 h-16 w-16 bg-gray-100 rounded-md overflow-hidden">
                                                        <img :src="productForm.imagePreview" alt="Product preview" class="h-full w-full object-cover">
                                                    </div>
                                                    <div v-else class="flex-shrink-0 h-16 w-16 bg-gray-100 rounded-md flex items-center justify-center">
                                                        <svg class="h-8 w-8 text-gray-300" fill="currentColor" viewBox="0 0 24 24">
                                                            <path d="M24 20.993V24H0v-2.996A14.977 14.977 0 0112.004 15c4.904 0 9.26 2.354 11.996 5.993zM16.002 8.999a4 4 0 11-8 0 4 4 0 018 0z" />
                                            ...
                                            <div v-if="errors.image" class="text-red-500 text-sm mt-1">{{ errors.image[0] }}</div>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <div class="mt-1">
                                                <select v-model="productForm.status" id="product-status" name="product-status"
                                                    class="shadow-sm focus:ring-green-500 focus:border-green-500 block w-full sm:text-sm border-gray-300 rounded-md">
                    ...
                    <div class="bg-gray-50 px-4 py-3 sm:px-6 flex flex-col-reverse sm:flex-row sm:justify-end space-y-3 space-y-reverse sm:space-y-0 sm:space-x-3">
                        <button type="button" @click="closeModal" id="cancel-product-btn"
                            class="w-full sm:w-auto inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 sm:text-sm">
                            Cancel
                        </button>
...
// Add this computed property after the filteredProducts computed property
